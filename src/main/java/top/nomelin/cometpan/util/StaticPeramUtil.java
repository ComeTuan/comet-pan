...
public class StaticPeramUtil {
    ...
    // 替换成你的AK (产品密)
    public  static String accessKeyId = "accessKeyId";// 你的accessKeyId,填你自己的 上文配置所得  自行配置
    public static String accessKeySecret = "accessKeySecret";// 你的accessKeySecret,填你自己的 上文配置所得 自行配置
    // 必填:短信签名-可在短信控制台中找到
    public  static String SignName ="短信签名"; // 阿里云配置你自己的短信签名填入
    // 必填:短信模板-可在短信控制台中找到
    public static String TemplateCode = "短信模板"; // 阿里云配置你自己的短信模板填入

    public static void main(String[] args) {
        String cods=generateCode();
        String phone = "你的手机号码"; //此处可输入你的手机号码进行测试
        getPhonemsg(phone,cods);
    }
